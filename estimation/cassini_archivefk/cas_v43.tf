...
----------------------------------------------------------
   ...
   Cassini Frame Kernel Version:
           ...
           TEXT_KERNEL_ID += 'CASSINI_FRAMES V4.3.0 31-JAN-2024 FK'

           \begintext

   Version 4.3 -- January 31, 2024 -- Boris Semenov

           The version 4.3 merges two non-competing updates released in
           2021 and 2023 under the same name ``cas_v43.tf'' due mis-
           coordination within the NAIF team. The version entries for
           these updates were:

           November 25, 2021 -- Marc Costa Sitja

            --   Updated alignment of CASSINI_UVIS_SOL_OFF based on [55].

           August 14, 2023 -- Boris Semenov

            --   Added a new section defining DSK surface name/ID mappings,
                 initially providing mappings for Enceladus DSKs produced
                 by the JPL SSD group in 2023 (see [56]).

   Version 4.2 -- July 25, 2019 -- Boris Semenov

            --   Updated alignment of CASSINI_CIRS_FP3 and CASSINI_CIRS_FP4
                 based on [54].

   Version 4.1 -- September 20, 2018 -- Boris Semenov

            --   updated alignments of CASSINI_RPWS_EXPLUS,
                 CASSINI_RPWS_EXMINUS, and CASSINI_RPWS_EZPLUS frames.
                 (These updates were originally provided in a temporary
                 FK ``cas_rpwc_bc_v3.tf''.)

            --   added CASSINI_RPWS_EDIPOLE, CASSINI_RPWS_EXZPLANE,
                 CASSINI_RPWS_EXPZP, CASSINI_RPWS_EXMZP, and
                 CASSINI_RPWS_EDPZP frames. (These new frames were
                 originally provided in a temporary FK
                 ``cas_rpwc_bc_v3.tf''.)
...
----------------------------------------------------------
           ...
           53.   Email from Baptiste Cecconi, 07/20/2018 with
                 Cassini/RPWS/HFR calibrated directions and ``RPWS
                 Electrical Antenna Calibration.pdf'' attachment

           54.   Emails from Marcia Segura, UMD, ``Minor changes to the
                 Cassini CIRS FOV definition.'', March 7, 2019, and
                 ``FW: Revised CIRS kernels'', July 25, 2019, (with
                 cas_v40_rev190725.tf attachment).

           55.   Handout from Tracy Becker ``Proposed frames kernel update'',
                 October 15, 2014, provided by Joshua Cowell via email on
                 November 11, 2021.

           56.   Park, R. S., Mastrodemos, N., Jacobson, R. A., Berne, A., 
                 Vaughan, A. T., Hemingway, D. J., et al. (2024). 
                 The global shape, gravity field, and libration of 
                 Enceladus. Journal of Geophysical Research: Planets, 129, 
                 e2023JE008054. https://doi.org/10.1029/2023JE008054
...
----------------------------------------------------------
   ...
   The following Cassini frames are defined in this kernel file:
           ...
           ------------------------
            ...
            CASSINI_RPWS_EDIPOLE     CASSINI_SC_COORD         FIXED    -82735
            CASSINI_RPWS_EXZPLANE    CASSINI_SC_COORD         FIXED    -82736
            CASSINI_RPWS_EXPZP       CASSINI_SC_COORD         FIXED    -82737
            CASSINI_RPWS_EXMZP       CASSINI_SC_COORD         FIXED    -82738
            CASSINI_RPWS_EDPZP       CASSINI_SC_COORD         FIXED    -82739
   ...
   (The RPWS frames with IDs -82735 .. -82739 are exceptions from this
   pattern.)
   ...
   The diagram below shows the Cassini frames hierarchy:
           ...
           'J2000' INERTIAL
             ...
             'CASSINI_SC_COORD'
                 ...
                 'CASSINI_RPWS_LP'
                  |
                 'CASSINI_RPWS_EDIPOLE'
                  |
                 'CASSINI_RPWS_EXZPLANE'
                  |
                 'CASSINI_RPWS_EXPZP'
                  |
                 'CASSINI_RPWS_EXMZP'
...
Composite Infrared Spectrometer Focal Plane #3 (CIRS_FP3)
   ...
   It was implemented by these keywords:
   ...
   [54] provides the following updated rotation matrix that takes
   vectors represented in the CIRS_FP3 frame into the CIRS_FPB frame
   follows:

           [     ]    [     ]  [             ]  [            ]
           [ ROT ]  = [ 0.0 ]  [ -0.00080214 ]  [ 0.02692902 ]
           [     ]    [     ]  [             ]  [            ]
                             Z                X               Y
...
Composite Infrared Spectrometer Focal Plane #4 (CIRS_FP4)
   ...
   [54] provides the following updated rotation matrix that takes
   vectors represented in the CIRS_FP4 frame into the CIRS_FPB frame
   follows:
...
(UVIS_SOL_OFF)
   ...
   The initial rotation matrix that takes vectors represented in the
   ...
   This definition is superseded by (from [55]):

           [     ]    [        ]  [     ]  [          ]
           [ ROT ]  = [ -110.0 ]  [ 0.0 ]  [ -0.16500 ]
           [     ]    [        ]  [     ]  [          ]
                                X        Z             Y
           ...
           TKFRAME_-82849_ANGLES       = ( -110.0,    0.0,  -0.16500 )
...
RPWS Electric Antenna System
   ...
   The following RPWS antenna frame alignments were implemented in the
   FK versions 2.7 to 4.0:
   ...
   Starting with FK version 4.1, the alignments of the antenna frames
   were changed based on [53]:

      Here are the calibrated direction and length for the electric
      antennas of Cassini/RPWS/HFR. There are 4 effective antennas
      listed below. The calibrated antenna parameters are provided as a
      direction in spherical coordinate: colatitude (TH) and azimuth
      (PH) in the spacecraft frame
      ...
      Antenna Eu, Ev, Ew and Ex are also respectively referred to as
      X+, X-, Z and Dipole in some publications.

   The calibration report (RPWS Electrical Antenna Calibration.pdf)
   specified Ex TH = -0.7.
   ...
   Antenna Frame Definitions:
           ...
           TKFRAME_-82731_ANGLES     = ( -17.0,  -108.3,     0.0 )
           TKFRAME_-82731_AXES       = (     3,       2,       1 )
           ...
           TKFRAME_-82732_ANGLES     = (-163.8,  -107.8,     0.0 )
           TKFRAME_-82732_AXES       = (     3,       2,       1 )
           ...
           TKFRAME_-82733_ANGLES     = ( -90.6,   -29.3,     0.0 )
           TKFRAME_-82733_AXES       = (     3,       2,       1 )
           ...
           FRAME_CASSINI_RPWS_EDIPOLE = -82735
           FRAME_-82735_NAME         = 'CASSINI_RPWS_EDIPOLE'
           FRAME_-82735_CLASS        = 4
           FRAME_-82735_CLASS_ID     = -82735
           FRAME_-82735_CENTER       = -82
           TKFRAME_-82735_SPEC       = 'ANGLES'
           TKFRAME_-82735_RELATIVE   = 'CASSINI_SC_COORD'
           TKFRAME_-82735_ANGLES     = (  +0.7,   -89.3,     0.0 )
           TKFRAME_-82735_AXES       = (     3,       2,       1 )
           TKFRAME_-82735_UNITS      = 'DEGREES'

           \begintext


RPWS Supporting Frames

   To facilitate computation of and searches on the elevation of a
   target above the CASSINI s/c XZ plane needed for RPWS electric
   antennae data processing, as requested in [53], this supplementary
   frame has its +Z axis aligned with the s/c +Y axis and its +X axis
   aligned with the s/c +X axis.
           ...
           FRAME_CASSINI_RPWS_EXZPLANE = -82736
           FRAME_-82736_NAME         = 'CASSINI_RPWS_EXZPLANE'
           FRAME_-82736_CLASS        = 4
           FRAME_-82736_CLASS_ID     = -82736
           FRAME_-82736_CENTER       = -82
           TKFRAME_-82736_SPEC       = 'ANGLES'
           TKFRAME_-82736_RELATIVE   = 'CASSINI_SC_COORD'
           TKFRAME_-82736_ANGLES     = (   0.0,     0.0,   +90.0 )
           TKFRAME_-82736_AXES       = (     3,       2,       1 )
           TKFRAME_-82736_UNITS      = 'DEGREES'

           \begintext

   Additional frames for this purpose are defined below for each of these
   three pairs of antennae -- EXPLUS/EZPLUS, EXMINUS/EZPLUS, and DIPOLE/EZPLUS.
   These frames are named CASSINI_RPWS_EXPZP, CASSINI_RPWS_EXMZP, and
   CASSINI_RPWS_EDPZP. Each of these frames has its +Z along the cross
   product and +X axis along the sum of the two antennae directions. For
   example +Z of CASSINI_RPWS_EXPZP is EXPLUS cross EZPLUS and +X of
   CASSINI_RPWS_EXPZP is unit EXPLUS + unit EZPLUS.


      CASSINI_RPWS_EXPZP:

           Rotation from the EXPLUS/EZPLUS frame to the s/c frame::

           [     ]    [               ]  [               ]  [               ]
           [ ROT ]  = [  -40.34786728 ]  [   25.22561675 ]  [  -60.14509847 ]
           [     ]    [               ]  [               ]  [               ]
                                       Z                  Y                  X
           ...
           FRAME_CASSINI_RPWS_EXPZP  = -82737
           FRAME_-82737_NAME         = 'CASSINI_RPWS_EXPZP'
           FRAME_-82737_CLASS        = 4
           FRAME_-82737_CLASS_ID     = -82737
           FRAME_-82737_CENTER       = -82
           TKFRAME_-82737_SPEC       = 'ANGLES'
           TKFRAME_-82737_RELATIVE   = 'CASSINI_SC_COORD'
           TKFRAME_-82737_ANGLES     = (  -40.34786728,   25.22561675,  -60.14509847 )
           TKFRAME_-82737_AXES       = (    3,             2,             1          )
           TKFRAME_-82737_UNITS      = 'DEGREES'
      ...
      CASSINI_RPWS_EXMZP:
           ...
           Rotation from the EXMINUS/EZPLUS frame to the s/c frame::

           [     ]    [               ]  [               ]  [               ]
           [ ROT ]  = [ -140.60938937 ]  [   25.45737324 ]  [ -119.89365407 ]
           [     ]    [               ]  [               ]  [               ]
                                       Z                  Y                  X
           ...
           FRAME_CASSINI_RPWS_EXMZP  = -82738
           FRAME_-82738_NAME         = 'CASSINI_RPWS_EXMZP'
           FRAME_-82738_CLASS        = 4
           FRAME_-82738_CLASS_ID     = -82738
           FRAME_-82738_CENTER       = -82
           TKFRAME_-82738_SPEC       = 'ANGLES'
           TKFRAME_-82738_RELATIVE   = 'CASSINI_SC_COORD'
           TKFRAME_-82738_ANGLES     = ( -140.60938937,   25.45737324, -119.89365407 )
           TKFRAME_-82738_AXES       = (    3,             2,             1          )
           TKFRAME_-82738_UNITS      = 'DEGREES'
      ...
      CASSINI_RPWS_EDPZP:
           ...
           Rotation from the DIPOLE/EZPLUS frame to the s/c frame::

           [     ]    [               ]  [               ]  [               ]
           [ ROT ]  = [  -25.62560361 ]  [   38.71338039 ]  [  -51.17258951 ]
           [     ]    [               ]  [               ]  [               ]
                                       Z                  Y                  X
           ...
           FRAME_CASSINI_RPWS_EDPZP  = -82739
           FRAME_-82739_NAME         = 'CASSINI_RPWS_EDPZP'
           FRAME_-82739_CLASS        = 4
           FRAME_-82739_CLASS_ID     = -82739
           FRAME_-82739_CENTER       = -82
           TKFRAME_-82739_SPEC       = 'ANGLES'
           TKFRAME_-82739_RELATIVE   = 'CASSINI_SC_COORD'
           TKFRAME_-82739_ANGLES     = (  -25.62560361,   38.71338039,  -51.17258951 )
           TKFRAME_-82739_AXES       = (    3,             2,             1          )
           TKFRAME_-82739_UNITS      = 'DEGREES'
...
DSK Surface NAIF Names/ID Codes -- Definition Section
========================================================================

   This section contains name to NAIF ID mappings for the DSK surfaces
   created based on Cassini mission data.

   The following surface name-ID mappings are defined for surfaces
   representing Enceladus shape models produced by the JPL Solar System
   Dynamics (SSD) group (see [55]):

             Surface Name          Surface ID     Body ID
      ---------------------------  ----------  -------------
      CAS_SSD_SPC_0128ICQ_V1          20101         602
      CAS_SSD_SPC_0256ICQ_V1          20102         602
      CAS_SSD_SPC_0512ICQ_V1          20103         602
      CAS_SSD_SPC_1024ICQ_V1          20104         602
      CAS_SSD_SPC_SOUTH100M_V1        20105         602
      CAS_SSD_SPC_SOUTH050M_V1        20106         602
      CAS_SSD_SPC_SOUTH025M_V1        20107         602
      CAS_SSD_SPC_EQ035M_V1           20108         602

           \begindata

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_0128ICQ_V1'
           NAIF_SURFACE_CODE        += 20101
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_0256ICQ_V1'
           NAIF_SURFACE_CODE        += 20102
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_0512ICQ_V1'
           NAIF_SURFACE_CODE        += 20103
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_1024ICQ_V1'
           NAIF_SURFACE_CODE        += 20104
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_SOUTH100M_V1'
           NAIF_SURFACE_CODE        += 20105
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_SOUTH050M_V1'
           NAIF_SURFACE_CODE        += 20106
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_SOUTH025M_V1'
           NAIF_SURFACE_CODE        += 20107
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_EQ035M_V1'
