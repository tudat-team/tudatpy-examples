...
covariance_input.set_constant_weight_per_observable(weights_per_observable)
covariance_output = estimator.compute_covariance(covariance_input)
diagonal_covariance = covariance_output.covariance  Covariance matrix
print(f'diagonal_covariance:\n\n{diagonal_covariance}\n')
"""
...
COV_sub = diagonal_covariance[np.ix_(np.sort(sorted_indices)[:3], np.sort(sorted_indices)[:3])]  #Covariance restriction to first 3 (spatial) eigenvectors
