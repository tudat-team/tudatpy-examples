...
Notice that there is a change in the number of revolutions around the Sun between the two transfers: the high $\Delta V$ transfer takes a considerably longer path for a comparable transfer time. The thrust acceleration of the high $\Delta V$ trajectory is, as a consequence, 2 orders of magnitude higher than that for the low $\Delta V$ trajectory.
